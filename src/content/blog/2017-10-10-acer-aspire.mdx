...
<Image src={sony} alt="The Adapter and tape in question" class="b-3 b-black" style="filter: drop-shadow(7px 7px 0 rgb(0 0 0 / 1));"/>

The adaptor I pulled off of my old laptop's HDD.

<Image src={acer} alt="The Hard Drive assembly in the Acer" class="b-3 b-black" style="filter: drop-shadow(7px 7px 0 rgb(0 0 0 / 1));"/>
