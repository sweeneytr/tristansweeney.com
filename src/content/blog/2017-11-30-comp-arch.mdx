...
1,800 square feet of space, and had 20,000 vacuum tubes. Using a modern 14nm manufacturing
process
...
. Conservatively assuming we'll need 10x the transistors to implement the same logic
the tubes did, a transistor-based ENIAC could fit into a 20th of a square centimeter.
