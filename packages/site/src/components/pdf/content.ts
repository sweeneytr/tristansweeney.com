      ...
      roles: [
        {
          ...
          start: "Jun 2025",
          points: [
            "Leads team of SWEs improving integration development velocity",
            "Enabled AI-driven development, eliminating boilerplate to develop integrations",
            "Integrated Just-in-Time access management for AWS RDS and GCP CloudSQL",
            "Eliminated code bottlenecks by introducing modern JS practices and architecture",
            "Refactored and packaged legacy codebase for self-hosting in FedRAMP high environments",
            "Consolidated tooling, improving DevX and reducing CI/CD complexity",
          ],
        },
      ],
    },
